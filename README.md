# [dibk-bus-terrasse](https://dibk-bus-terrasse.firebaseapp.com/) [![Build Status](https://travis-ci.com/netliferesearch/dibk-bus-terrasse.svg?token=7NpjNJdFW93Qs1rPvcce&branch=master)](https://travis-ci.com/netliferesearch/dibk-bus-terrasse)

The dibk-bus-terrasse project is a wizard that uses [losen](https://github.com/netliferesearch/losen).  
...
The data for this wizard can be found in `src/api/bus-terrasse.json`.

## Deploy

The project is hosted on [`Firebase`](https://console.firebase.google.com/u/0/project/dibk-bus-terrasse/overview) :fire:. You need to be invited to it to be able to deploy.
